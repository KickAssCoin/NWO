...
uint256 hashGenesisBlock("0x8f35d85743c9680618e73c4dc58bd292d9f9141ac34f014ce15c4c8041d3b355");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // NWOcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "NWOcoin Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal nwocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NWOcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
		...
		//   CTransaction(hash=730f0c8ddc, ver=2, vin.size=1, vout.size=1, nLockTime=0, strTxComment=text:NWOcoin genesis block)
        ...
        // Genesis block
        const char* pszTimestamp = "nwo started legion formatis elobortis";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		txNew.strTxComment = "text:NWOcoin genesis block";
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1388552203;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1001326125;
        ...
        assert(block.hashMerkleRoot == uint256("0x613ac6ec091b5e95b5d7b600e1c7c6bee0e91971bc683fe25f189501fd89f7f9"));
